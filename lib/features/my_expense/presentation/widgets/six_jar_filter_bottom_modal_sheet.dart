...
void showSixJarFilterBottomModalSheet({
  required BuildContext context,
  required TextEditingController startDateRangeController,
  required TextEditingController endDateRangeController,
}) {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  builder: (context, state) {
                    ...
                    return Wrap(
                      ...
                      children: [
                        ...
                        SixJarSelectionChip(
                          chipTitle: AppTextConstants.jarNecessitiesName,
                          chipTitleActiveColor: AppColors.background,
                          chipTitleInActiveColor: AppColors.necessitiesColor,
                          chipIconNotSelectedIcon: Icons.shopping_cart,
                          chipIconSelectedIcon: Icons.shopping_cart,
                          iconActiveColor: AppColors.background,
                          iconInActiveColor: AppColors.necessitiesColor,
                          chipActiveBgColor: AppColors.necessitiesColor,
                          chipInActiveBgColor: AppColors.necessitiesColor
                              .withOpacity(0.3),
                          isSelected:
                              state.selectedJar ==
                        ...
                        SixJarSelectionChip(
                          ...
                          chipTitleActiveColor: AppColors.background,
                          chipTitleInActiveColor: AppColors.playColor,
                          chipIconNotSelectedIcon: Icons.sports_esports,
                          chipIconSelectedIcon: Icons.sports_esports,
                          iconActiveColor: AppColors.background,
                          iconInActiveColor: AppColors.playColor,
                          chipActiveBgColor: AppColors.playColor,
                          chipInActiveBgColor: AppColors.playColor.withOpacity(
                            0.3,
                          ),
                          isSelected:
                              state.selectedJar == AppTextConstants.jarPlayName,
                          onTap: () {
                            bloc.add(
                              SelectJarEvent(AppTextConstants.jarPlayName),
                            );
                          },
                        ),
                        ...
                        SixJarSelectionChip(
                          chipTitle: AppTextConstants.jarEducationName,
                          chipTitleActiveColor: AppColors.background,
                          chipTitleInActiveColor: AppColors.educationColor,
                          chipIconNotSelectedIcon: Icons.school,
                          chipIconSelectedIcon: Icons.school,
                          iconActiveColor: AppColors.background,
                          iconInActiveColor: AppColors.educationColor,
                          chipActiveBgColor: AppColors.educationColor,
                          chipInActiveBgColor: AppColors.educationColor
                              .withOpacity(0.3),
                          isSelected:
                              state.selectedJar ==
                          ...
                          onTap: () {
                            bloc.add(
                              SelectJarEvent(AppTextConstants.jarEducationName),
                            );
                          },
                        ),
                        ...
                        // Jar 4 savings chip
                        SixJarSelectionChip(
                          chipTitle: AppTextConstants.jarSavingsName,
                          chipTitleActiveColor: AppColors.background,
                          chipTitleInActiveColor: AppColors.savingsColor,
                          ...
                          chipInActiveBgColor: AppColors.savingsColor
                              .withOpacity(0.3),
                          isSelected:
                              state.selectedJar ==
                          ...
                          onTap: () {
                            bloc.add(
                              SelectJarEvent(AppTextConstants.jarSavingsName),
                            );
                          },
                        ),
                        ...
                        SixJarSelectionChip(
                          ...
                          chipTitleActiveColor: AppColors.background,
                          chipTitleInActiveColor: AppColors.giveColor,
                          chipIconNotSelectedIcon: Icons.volunteer_activism,
                          chipIconSelectedIcon: Icons.volunteer_activism,
                          iconActiveColor: AppColors.background,
                          iconInActiveColor: AppColors.giveColor,
                          chipActiveBgColor: AppColors.giveColor,
                          chipInActiveBgColor: AppColors.giveColor.withOpacity(
                            0.3,
                          ),
                          isSelected:
                              state.selectedJar == AppTextConstants.jarGiveName,
                          onTap: () {
                            bloc.add(
                              SelectJarEvent(AppTextConstants.jarGiveName),
                            );
                          },
                        ),
                        ...
                        SixJarSelectionChip(
                          chipTitle: AppTextConstants.jarFinancialFreedomName,
                          chipTitleActiveColor: AppColors.background,
                          chipTitleInActiveColor:
                              AppColors.financialFreedomColor,
                          chipIconNotSelectedIcon: Icons.attach_money,
                          chipIconSelectedIcon: Icons.attach_money,
                          iconActiveColor: AppColors.background,
                          iconInActiveColor: AppColors.financialFreedomColor,
                          chipActiveBgColor: AppColors.financialFreedomColor,
                          chipInActiveBgColor: AppColors.financialFreedomColor
                              .withOpacity(0.3),
                          isSelected:
                              state.selectedJar ==
                ...
                // Range Slider
                const SixJarFilterSlider(min: 0, max: 200000, divisions: 10),
